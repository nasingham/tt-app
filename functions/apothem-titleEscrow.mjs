...
const titleEscrowFactory = "0xce28778bE6cF32ef3Ccbc09910258DF592F3b6F1"
//ABI of Deployer
const contractABI = [
    {
      "inputs": [],
  ...
  export const handler = async (event) => {
    try {
        ...
        const chainId = 51; //apothem networkID
        ...
        // const startBlock = 63281088; //creation block of apothem title Escrow Factory
