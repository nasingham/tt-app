...
const deployer = "0x5aA71Cc9559bC5e54E9504a81496d9F8454721F5"
...
export const handler = async (event) => {
    try {
        ...
        const insertQuery = 'INSERT INTO sepolia_titleEscrowsCreated (txnHash, titleBlockNumber, tokenRegistry, tokenId, titleEscrow, removed) VALUES ?';
