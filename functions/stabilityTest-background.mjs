...
export default async(request,context) => {
    ...
    // } else{
        ...
        try{
            ...
            const fetch_deployments = await fetch('https://tradetrust-scan.netlify.app/.netlify/functions/stabilityTest-deployer');
            const fetch_titleCreated = await fetch('https://tradetrust-scan.netlify.app/.netlify/functions/stabilityTest-titleEscrow');
